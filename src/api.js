...
const cityFeatureCodes = `featureCode=PPLC&featureCode=PPLA` // See https://www.geonames.org/export/codes.html
...
export const getCitiesByCountry = async (query, numberOfCities) => {
  ...
  // Get cities based on queried country and make sure the country is correct with country code
